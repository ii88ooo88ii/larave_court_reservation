...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create New Pricing</h1>
                        ...
                        <div class="form-group">
                            ...
                            <select name="court_id" id="court_id" class="form-control @error('court_id') is-invalid @enderror" required>
                                ...
                                @foreach($courts as $court)
                                    <option value="{{ $court->id }}" {{ old('court_id', $selectedCourt) == $court->id ? 'selected' : '' }}>
                                        {{ $court->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="currency" id="currency" class="form-control @error('currency') is-invalid @enderror" value="{{ old('currency', 'USD') }}" required>
                            @error('currency')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="peak_price" id="peak_price" class="form-control" value="{{ old('peak_price') }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="off_peak_price" id="off_peak_price" class="form-control" value="{{ old('off_peak_price') }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="minimum_hours" id="minimum_hours" class="form-control @error('minimum_hours') is-invalid @enderror" value="{{ old('minimum_hours', 1) }}" required>
                            @error('minimum_hours')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
